...
function DepartmentsPage() {
  ...
  const handleCreate = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const data: CreateDepartmentRequest = {
        ...
        exec_id: formData.get('exec_id') as string || 'supAdmin' // Default to 'supAdmin' if empty
      };
  ...
  const handleUpdate = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const data: CreateDepartmentRequest = {
        name: formData.get('name') as string,
        exec_id: exec_id || 'supAdmin' // Default to 'supAdmin' if empty
      };
              ...
              <ModalBody>
                <div className="space-y-4">
                  ...
                  <Input
                    ...
                    name="exec_id"
                    placeholder="Leave empty for supAdmin"
                  />
                </div>
              </ModalBody>
              <ModalFooter>
...
export default withSupAdminAuth(DepartmentsPage);
