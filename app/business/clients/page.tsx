...
const ClientsPage = () => {
    ...
    useEffect(() => {
        // Verify this page can only be accessed by clients role
    ...
    return (
        <div className="container mx-auto p-6 max-w-7xl">
            ...
            <p className="text-default-500 mb-6">Manage system clients and permissions</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <Card className="p-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-default-500">Total clients</p>
