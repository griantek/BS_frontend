...
function JournalByEmailContent({ id }: { id: string }) {
  ...
  const handleBack = () => {
    router.push("/business/editor/journals?view=byEmail");
  };
  ...
  const handleEditJournal = (journalId: number) => {
    router.push(`/business/editor/edit/journal/${journalId}`);
  };
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <Card className="w-full">
                      ...
                      <CardBody className="space-y-4">
                        ...
                        {/* <Accordion>
                          <AccordionItem title="Login Credentials" className="text-sm">
                            <div className="px-2 py-1 space-y-2">
                              ...
                              <div>
                                <h3 className="text-xs text-gray-500">Password</h3>
                                <p className="font-medium">{journal.password}</p>
                              </div>
                              {journal.orcid_username1 && (
                                <>
                                  <div>
                                    <h3 className="text-xs text-gray-500">ORCID Username</h3>
                                    <p className="font-medium">{journal.orcid_username1}</p>
                                  </div>
                                  <div>
                                    <h3 className="text-xs text-gray-500">ORCID Password</h3>
                                    <p className="font-medium">{journal.password1}</p>
                                  </div>
                                </>
                              )}
                            </div>
