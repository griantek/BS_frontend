...
function ProspectContent({ regId }: { regId: string }) {
  ...
  // Simplify permissions for leads section - more permissive than executive section
  const permissions = {
  ...
  return (
    <>
      ...
      <Button
        ...
        onClick={() => router.push('/business/conversion/prospects')}
      >
            ...
            <div className="flex gap-3">
              {permissions.canSendQuotation && (
                <Button
                  color="secondary"
                  variant="flat"
                  onClick={() => router.push(`/business/conversion/prospects/quotation/${regId}`)}
                >
                  Send Quotation
                </Button>
              )}
              {permissions.canRegister && (
                <Button
                  color="success"
                  variant="flat"
                  onPress={() => router.push(`/business/conversion/prospects/register/${regId}`)}
                >
                  Register
                </Button>
              )}
              {permissions.canEdit && (
                <Button
                  color="primary"
                  variant="flat"
                  onPress={() => router.push(`/business/conversion/prospects/edit/${regId}`)}
                >
                  Edit Details
                </Button>
              )}
...
export default withLeadsAuth(ProspectView);
