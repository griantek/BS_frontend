        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="p-6 col-span-2 bg-content1">
            ...
            {lead.remarks && (
              <div className="mb-6 p-4 bg-default-50 dark:bg-default-100/10 rounded-lg border border-divider">
                <div className="flex items-center mb-2">
                  ...
                  <h3 className="text-md font-medium text-foreground-600">
                    Remarks
                  </h3>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div>
                <h3 className="text-sm font-medium text-foreground-400 mb-1">
                  Domain / Subject
                </h3>
                <p className="text-foreground text-lg font-medium">
                  {lead.domain || "Not specified"}
                </p>
              </div>
          ...
          <Card className="p-6 h-fit bg-content1">
            ...
            <div className="space-y-4">
              <div className="bg-default-50 dark:bg-default-100/5 p-3 rounded-lg">
                <h4 className="text-xs font-medium text-foreground-400">
                  Lead ID
                </h4>
            ...
            <div className="flex flex-col gap-2">
              {lead.followup_status?.toLowerCase() != "converted" && (
                <>
                  <Button
                    color="primary"
                  ...
                  <Button
                    ...
                    onClick={() => {
                      router.push(
                        `/business/executive/leads/approve/${lead.id}`
                      );
                    }}
                  >
                    Approve Lead
                ...
                {updateSuccess ? (
                  ...
                  <div className="space-y-4">
                    <Select
                      label="Prospect Type"
                      selectedKeys={
                        formData.prospectus_type
                          ? [formData.prospectus_type]
                          : []
                      }
                      onChange={(e) =>
                        handleChange("prospectus_type", e.target.value)
                      }
                    >
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label
                        ...
                        className="text-sm font-medium text-foreground-600"
                      >
                        Follow-up Date
                      </label>
                      <input
                        ...
                        onChange={(e) =>
                          handleChange("followup_date", e.target.value)
                        }
...
export default withExecutiveAuth(LeadDetailPage);
