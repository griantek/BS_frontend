...
function JournalsByEmailPage() {
  ...
  const isStandalone = pathname === '/business/executive/journals/byEmail';

  // Fetch journals data using the executive API
  const fetchEmailsData = useCallback(async () => {
    try {
      ...
      // Use the executive API function to get journal data
  ...
  const handleEmailClick = (email: string) => {
    ...
    router.push(`/business/executive/journals/byEmail/${encodedEmail}`);
  };
